    ...
    >
      {toasts.map((toast) => {
        ...
        return (
          <div
            key={toast.id}
            className={`pointer-events-auto flex items-start gap-3 rounded-lg border bg-surface px-4 py-3 shadow-md animate-slide-up ${t.border}`}
          >
            ...
            <button
              ...
              className="shrink-0 rounded p-0.5 text-subtle-foreground transition hover:text-foreground"
              aria-label="Dismiss"
            >
